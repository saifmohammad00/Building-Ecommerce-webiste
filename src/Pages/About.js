...
const About = () => {
    const imgurl="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png";
    return <Container>
        <h1 className="text-center mt-5 mb-5">About</h1>
        <Row className="justify-content-center">
                <Col md={4} className="text-center">
                    <Image src={imgurl} roundedCircle style={{ maxWidth: "200px", maxHeight: "200px" }} className="mb-4" />
                </Col>
                <Col md={8}>
                    <p>
