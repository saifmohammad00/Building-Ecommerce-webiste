const About = () => {
    return <div>
        ...
        <div className="d-flex justify-content-between" style={{width:"80rem", justifyContent:"center"}}>
            <img src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png" style={{maxWidth:"200px", borderRadius:"100px"}}/>
